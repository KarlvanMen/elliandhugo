        ...
        if(isset($_SESSION['id'])){    
                ...
                if(!empty($_POST)){
                        ...
                        if (!empty($_POST["pied_url"])) {
                                if(preg_match('/^[A-Za-z][A-Za-z0-9]*(?:_[A-Za-z0-9]+)*$/', test_input($_POST["pied_url"]))){
                                        $url = test_input($_POST["pied_url"]);                        
                                } else {
                                        $urlErr = 'Only letters, numbers, and underscore are allowed';
                                }
                        ...
                        <?php
                               ...
                               if(!empty($category_array)){
                                       foreach($category_array as $cate):?>
                                               <label for="pied_cat"><?php echo $cate->category; ?></label>
                                               <input
                                                       type="checkbox" 
                                                       name="pied_cat[<?php echo $catCount ?>]" 
                                                       value= '<?php 
                                                                       echo $cate->category; 
                                                               ?>' 
                                                       <?php 
